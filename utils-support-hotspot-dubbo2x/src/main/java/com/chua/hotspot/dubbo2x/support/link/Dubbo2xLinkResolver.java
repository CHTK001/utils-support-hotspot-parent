package com.chua.hotspot.dubbo2x.support.link;
 ...
 * @since 2024/12/11
 */
public class Dubbo2xLinkResolver implements LinkResolver {
    ...
    public static void insertResponsePoint(Object call) {
        if (null == call || !(call instanceof RpcResult)) {
            return;
        }
        ...
        RpcResult result = (RpcResult) call;
    ...
    public static void receivePoint(Object invoke) {
        ...
        RpcResult result = (RpcResult) invoke;
        String attachment = (String) result.getAttachment(LINK_RES_SPAN);
        if (null == attachment) {
            return;
        }
