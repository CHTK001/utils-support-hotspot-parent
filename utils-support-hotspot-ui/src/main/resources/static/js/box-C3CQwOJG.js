...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createBaseVNode("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [_cache[1] || (_cache[1] = createStaticVNode('<div class="rounded-2.5 flex items-center justify-center shadow-bg1" style="width:140px;height:140px;" data-v-d06809b2><div data-v-a4c4d738="" class="relative flex justify-between items-center text-white" data-v-d06809b2><div class="boxes" data-v-d06809b2><div class="box" data-v-d06809b2><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div></div><div class="box" data-v-d06809b2><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div></div><div class="box" data-v-d06809b2><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div></div><div class="box" data-v-d06809b2><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div><div data-v-d06809b2></div></div></div></div></div>', 1)), $setup.props.showNumber ? (openBlock(), createElementBlock("p", _hoisted_4, [createTextVNode(toDisplayString($setup._step) + " ", 1), _cache[0] || (_cache[0] = createBaseVNode("span", {
    class: "text-sm"
...
const box = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d06809b2"], ["__file", "H:/workspace/2/vue-support-parent-starter/packages/components/ScLoading/layout/box.vue"]]);
export {
  box as default
};
