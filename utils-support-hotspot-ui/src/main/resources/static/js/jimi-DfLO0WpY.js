...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ...
    class: "rounded-2.5 flex items-center justify-center shadow-bg",
    style: {
      "width": "100px",
      "height": "100px"
    }
    ...
    class: "justify-content-center jimu-primary-loading"
  })])])], -1)), $setup.props.showNumber ? (openBlock(), createElementBlock("p", _hoisted_4, [createTextVNode(toDisplayString($setup._step) + " ", 1), _cache[0] || (_cache[0] = createBaseVNode("span", {
    class: "text-sm"
...
const jimi = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0ee7b834"], ["__file", "H:/workspace/2/vue-support-parent-starter/packages/components/ScLoading/layout/jimi.vue"]]);
export {
  jimi as default
};
