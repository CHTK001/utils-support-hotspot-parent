...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createBaseVNode("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [_cache[1] || (_cache[1] = createStaticVNode('<div class="rounded-2.5 flex items-center justify-center" data-v-dbde9a5b><div data-v-a4c4d738="" class="relative flex justify-between items-center text-white" data-v-dbde9a5b><div class="eye-lid" data-v-dbde9a5b><div class="eye" data-v-dbde9a5b><div class="cornea" data-v-dbde9a5b><div class="white-pupil" data-v-dbde9a5b></div></div></div></div></div></div>', 1)), $setup.props.showNumber ? (openBlock(), createElementBlock("p", _hoisted_4, [createTextVNode(toDisplayString($setup._step) + " ", 1), _cache[0] || (_cache[0] = createBaseVNode("span", {
    class: "text-sm"
...
const loader3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-dbde9a5b"], ["__file", "H:/workspace/2/vue-support-parent-starter/packages/components/ScLoading/layout/loader3.vue"]]);
export {
  loader3 as default
};
