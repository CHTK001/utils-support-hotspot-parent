...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, [createBaseVNode("div", _hoisted_1, [createBaseVNode("div", _hoisted_2, [createBaseVNode("div", _hoisted_3, [_cache[1] || (_cache[1] = createStaticVNode('<div class="w-full rounded-2.5 flex items-center justify-center" style="width:200px;" data-v-7a87507c><div data-v-a4c4d738="" class="w-full flex justify-center items-center" data-v-7a87507c><div class="wrapper" data-v-7a87507c><div class="circle text" data-v-7a87507c></div><div class="circle text" data-v-7a87507c></div><div class="circle text" data-v-7a87507c></div><div class="shadow" data-v-7a87507c></div><div class="shadow" data-v-7a87507c></div><div class="shadow" data-v-7a87507c></div></div></div></div>', 1)), $setup.props.showNumber ? (openBlock(), createElementBlock("p", _hoisted_4, [createTextVNode(toDisplayString($setup._step) + " ", 1), _cache[0] || (_cache[0] = createBaseVNode("span", {
    class: "text-sm"
...
const loader5 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-7a87507c"], ["__file", "H:/workspace/2/vue-support-parent-starter/packages/components/ScLoading/layout/loader5.vue"]]);
export {
  loader5 as default
};
