 ...
 * @author CH
 */
public class MybatisSqlSessionTemplatePlugin extends BytebuddyPlugin {
    /**
    ...
    @Override
    public String name() {
        return "Mybatis-Session";
    }

    @Override
    public DynamicType.Builder.MethodDefinition.ReceiverTypeDefinition<?> transform(DynamicType.Builder<?> builder) {
        return builder.method(ElementMatchers.named("execute")).intercept(MethodDelegation.to(MybatisSqlSessionTemplatePlugin.class));
    }
