package com.chua.hotspot.jedis.support.plugin;
 ...
 * @version 4.0.0.34
 */
public class JedisPlugin extends BytebuddyPlugin {
    @RuntimeType
    public static Object intercept(
        ...
        span.setDescription("Redis createSocket: " + (host != null ? host + ":" + port : "unknown"));
        span.setCategory("REDIS");
        span.setProtocol("REDIS");
        
        try {
            Object result = NewTrackManager.invoke(callable);
            
            // 提取并报告 Jedis 连接信息
            extractAndReportJedisConnection(target, host, port);
     ...
     * 提取并报告 Jedis 连接信息
     */
    private static void extractAndReportJedisConnection(Object target, String host, Integer port) {
        try {
    ...
    public DynamicType.Builder.MethodDefinition.ReceiverTypeDefinition<?> transform(DynamicType.Builder<?> builder) {
        return builder.method(ElementMatchers.named("createSocket")).intercept(MethodDelegation.to(JedisPlugin.class));
    }
