...
abstract public class ConstructorAccess<T> {
    ...
    public static final String REFLECTASM = "reflectasm.";
    ...
    static public <T> ConstructorAccess<T> get(Class<T> type) {
        ...
        synchronized (loader) {
            ...
            if (accessClass == null) {
                ...
                cw.visit(Opcodes.V1_6, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, superclassNameInternal, null);
        ...
        if (!AccessClassLoader.areInSameRuntimeClassLoader(type, accessClass)) {
