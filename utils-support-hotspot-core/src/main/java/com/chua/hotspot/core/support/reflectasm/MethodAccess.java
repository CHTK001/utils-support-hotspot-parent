...
import static com.chua.hotspot.core.support.reflectasm.ConstructorAccess.REFLECTASM;
    ...
    static public MethodAccess get(Class type) {
        ...
        synchronized (loader) {
            ...
            if (accessClass == null) {
                ...
                MethodVisitor mv;
                cw.visit(V1_6, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, MethodAccess.class.getName().replace(".", "/"),
                        null);
                {
