...
import static com.chua.hotspot.core.support.utils.StringUtils.SYMBOL_LEFT_BIG_PARANTHESES_CHAR;
import static com.chua.hotspot.core.support.utils.StringUtils.SYMBOL_RIGHT_BIG_PARANTHESES_CHAR;
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch, Map<String, String> uriTemplateVariables) {
        ...
        if (pathIdxStart > pathIdxEnd) {
            ...
            for (int i = pattIdxStart; i <= pattIdxEnd; i++) {
                if (!pattDirs[i].equals(SYMBOL_ASTERISK_ANY)) {
                    return false;
                }
            }
            return true;
        ...
        while (pattIdxStart <= pattIdxEnd && pathIdxStart <= pathIdxEnd) {
            ...
            if (pattDir.equals(SYMBOL_ASTERISK_ANY)) {
                break;
            }
